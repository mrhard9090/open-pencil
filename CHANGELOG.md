...
- Accept `blur` as the radius in the `dropShadow`, `innerShadow` and blur effect helpers, as the `shadow` shorthand and the `blur` prop already do, and warn about any other option these helpers ignore instead of dropping it silently (#736).
