...
- Size a boolean operation made through the AI and MCP `boolean_*` tools to all of its operands, as the editor's boolean commands already do, instead of to the first operand (#738).
